...
if __name__ == '__main__':
    print("meva, gemini-pro, 30 prompts, score only, single scoring\n")

    # evaluator = ModelEvaluator('gemini-pro', 'hanna', 'hanna/hanna_stories_annotations.csv', num_prompts_eval=1, num_categories=1, bidir_eval=False, eval_rounds=1, verbose=False, query_mode="score only")

    evaluator = ModelEvaluator('gemini-pro', 'meva', 'meva/mans_wp.json', num_prompts_eval=50, num_categories=1, bidir_eval=True, eval_rounds=1, verbose=False, query_mode="analyze rate")
